...
print("=========================================================")
for i in range(a1):
    print(i + 1,"   ", mas_sim[i],"    ", mas_count[i],"   ", "%.5f" % mas_pi[i],"    ", mas_Ixi[i],"   ", "%.8f" % mas_k[i],"   ", mas_kod[i])
...
print("=========================================================")
for i in range(a2):
    print(i + 1,"   ", mas_sim2[i],"   ", mas_count2[i],"    ", "%.5f" % mas_pi2[i],"    ", mas_Ixi2[i],"   ", "%.8f" % mas_k2[i],"    ", mas_kod2[i])
...
print("=========================================================")
for i in range(a3):
    print(i + 1,"   ",mas_sim3[i], "   ", mas_count3[i], "   ",  "%.5f" % mas_pi3[i], "   ", mas_Ixi3[i], "   ",  "%.8f" % mas_k3[i], "   ", mas_kod3[i])
